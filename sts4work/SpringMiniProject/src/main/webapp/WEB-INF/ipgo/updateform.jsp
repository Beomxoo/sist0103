...
<form action="update" method="post" enctype="multipart/form-data">
	...
	<table class="table table-bordered">
		<tr>
			...
			<td>
				<input type="text" name="sangpum" class="form-control" style="width: 150px;" required="required" value="${dto.sangpum }">
			</td>
		</tr>
		<tr>
			<th class="table-light">상품가격</th>
			<td>
				<input type="text" name="price" class="form-control" style="width: 200px;" required="required" value="${dto.price }">
			</td>
		</tr>
		<tr>
