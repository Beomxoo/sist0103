...
<body>
	<div style="margin: 100px 100px;">
		<button type="button" class="btn btn-warning" onclick="location.href='addform'">학생정보입력</button>
			<br><br>
	<h5 class="alert alert-info">${count }명의 학생정보가 있습니다</h5>
	...
	<table class="table table-bordered" style="width: 800px; text-align: center;">
		...
		<c:forEach var="dto" items="${list }" varStatus="i">
			<tr>
				<td>${i.count }</td>
				<td>${dto.stuname }</td>
				<td><img class="stuimg" src="../${dto.stuphoto }"></td>
				<td>${dto.stuhp }</td>
				<td>${dto.stuaddr }</td>
				<td>
