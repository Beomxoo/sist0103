			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><input type="text" name="sangname" class="form-control"
						style="width: 150px;" required="required" value="${dto.sangname }"></td>
				</tr>
				<tr>
					<th>상품가격</th>
					<td><input type="text" name="sangprice" class="form-control"
						style="width: 150px;" required="required" value="${dto.sangprice }"></td>
				</tr>
				<tr>
					<th>상품색상</th>
					<td><input type="color" name="sangcolor" class="form-control"
						style="width: 200px;" required="required" value="${dto.sangcolor }"></td>
				</tr>
				<tr>
					<th>입고일</th>
					<td><input type="date" name="sangipgo" class="form-control"
						style="width: 250px;" required="required" value="${dto.sangipgo }"></td>
				</tr>
				<tr>
