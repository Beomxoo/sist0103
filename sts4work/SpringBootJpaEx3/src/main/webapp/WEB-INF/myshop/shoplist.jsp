...
<div style="margin: 100px 100px; width: 1000px;">
	<button type="button" class="btn btn-info" onclick="location.href='writeform'">상품입력</button>
	<br><br>
	...
	<table class="table table-bordered" style="text-align: center;">
		...
		<c:forEach var="dto" items="${list}" varStatus="i">
			<tr>
				<td>${i.count }</td>
				<td>${dto.sangname }</td>
				<td align="center"><div class="box" style="background-color: ${dto.sangcolor}"></div></td>
				<td>
