...
<div style="margin: 100px 100px;">
	...
	<form action="insert" method="post" enctype="multipart/form-data">
		<table class="table table-bordered" style="width: 500px; text-align: center; vertical-align: middle;">
			<tr>
				<th width="100" class="table-light">상품명</th>
				<td>
					<input type="text" name="sang" class="form-control" style="width: 130px;" required="required"> 
				</td>
			</tr>
			<tr>
				<th width="100" class="table-light">단가</th>
				<td>
					<input type="text" name="dan" class="form-control" style="width: 130px;" required="required"> 
				</td>
			</tr>
			<tr>
