...
public class HelloThController {
	...
	{
		list.add(new ShopDto(1,"핸드크림",10,2000,"black"));
		list.add(new ShopDto(2,"아이폰",5,80000,"pink"));
		list.add(new ShopDto(3,"갤럭시",8,3000,"green"));
		list.add(new ShopDto(4,"지갑",7,6000,"yellow"));
