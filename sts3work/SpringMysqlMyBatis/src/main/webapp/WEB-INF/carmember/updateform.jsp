	...
	<table class="table table-bordered" >
		...
		<tr>
			...
			<td width="200">
				...
				required="required" class="form-control" value="${dto.name }">
			</td>
		</tr>
		<tr>
			...
			<td width="200">
				...
				required="required" class="form-control" value="${dto.hp }">
			</td>
		</tr>
		<tr>
			...
			<td width="200">
				...
				required="required" class="form-control" value="${dto.addr }">
			</td>
		</tr>		
		<tr>
