...
<body>
	...
	<form action="read1" method="get">
		...
		<button type="submit" class="btn btn-info">get방식전송</button>
	</form>
	...
	<form action="read2" method="post">
		...
		구입일:<input type="date" name="guipday" size="10"><br>
		<button type="submit" class="btn btn-info">post방식전송</button>
	</form>
	
	<h2>mappost방식폼_dto</h2>
	<form action="read3" method="post">
		상품:<input type="text" name="sang" size="10"><br>
		가격:<input type="text" name="price" size="10"><br>
		색상:<input type="text" name="color" size="10"><br>
		<button type="submit" class="btn btn-info">mappost방식전송</button>
	</form>
