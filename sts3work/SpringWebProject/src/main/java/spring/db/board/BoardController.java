...
public class BoardController {
	...
	//@RequestParam 안에 : 현재페이지 읽는데 단 null일경우는 1페이지로 준다
	{
	...
	//insert
	@PostMapping("/insert")
	public String insert(@ModelAttribute BoardDto dto, @RequestParam ArrayList<MultipartFile> upload, HttpSession session,  @RequestParam String currentPage)
	{	
		//이미지가 업로드될폴더
