	...
	<form action="updateAction.jsp" method="post">
		...
		<table class="table table-bordered" style="width: 600px">
			...
			<tr>
				<th>이름</th>
				<td>
					<input type="text" name="name" class="form-control" value="<%=dto.getName() %>" style="width: 120px;">
				</td>
			</tr>
			...
			<tr>
				<th>성격</th>
				<td>
					<textarea style="width: 500px; height: 100px" placeholder="자유롭게 작성하기" name="memo"><%=dto.getMemo() %></textarea>
				</td>
			</tr>
			
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-outline-success">수정전송</button>
				</td>
			</tr>
		</table>
	</form>
