		...
		<%
			for(int i=0; i<list.size(); i++){
				...
				<tr>
					...
					<td>
					 <button type="button" class="btn btn-warning btn-small" onclick="location.href='updateForm.jsp?num=<%=dto.getNum()%>'">수정</button>
					 <button type="button" class="btn btn-danger btn-small" onclick="location.href='teamDelete.jsp?num=<%=dto.getNum()%>'">삭제</button>
					</td>
				</tr>
			<%}
		%>
