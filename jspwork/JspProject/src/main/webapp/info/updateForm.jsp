			...
			<table class="table table-bordered" style="width: 350px;">
				<tr>
					...
					<td><input type="text" name="name" placeholder="이름"
						required="required" class="form-control" style="width: 120px;" value="<%=dto.getName()%>">
					</td>
				</tr>
				<tr>
					<th class="table-warning" width="80">주소</th>
					<td>
					<input type="text" name="addr" placeholder="주소" required="required" class="form-control" style="width: 250px;" value="<%=dto.getAddr()%>">
					</td>
				</tr>
				<tr>
