...
<body>
	<div style="margin: 50px 100px; width: 1000px;">
		<button type="button" class="btn btn-info" onclick="location.href='addform.jsp'">게시글추가</button>
		<button type="button" class="btn btn-warning" onclick="location.href='boardlist2.jsp'">목록 보기</button><br><br>
		...
		<table class="table table-hover">
			...
			%>
				...
				<img alt="" src="../save/<%=dto.getImgname()%>" style="width: 30px;"></a>
				<%=dto.getSubject()%></td>
				<td><%=dto.getWriter() %></td>
