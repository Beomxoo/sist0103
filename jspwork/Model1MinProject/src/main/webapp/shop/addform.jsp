	...
	<form action="shop/addaction.jsp" method="post" enctype="multipart/form-data">
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<input type="file" name="photo" class="form-control" style="width: 300px;" placeholder="상품이미지">
				</td>
			</tr>
			<tr>
				<td style="width: 150px;" class="table-light"><b>상품가격</b></td>
				<td>
					<input type="text" name="price" class="form-control" style="width: 120px;"  required="required" placeholder="가격입력">
				</td>
			</tr>
			<tr>
