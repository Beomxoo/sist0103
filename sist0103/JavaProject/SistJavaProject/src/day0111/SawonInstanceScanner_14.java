...
class Emp {
	...
	public int getTotalPay() {
		int n = 0;
		n = gPay + getTimeSudang() + getFamilySudang();
		return n;
	}

	// 제목
	public static void showTitle() {
		System.out.println("***쌍용 1월 직원 급여현황***");
		System.out.println();
